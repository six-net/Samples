(function (a) {
    a.EZNEW.EZNEWUI("EZNEWSplitter", "", {});
    a.extend(a.EZNEW._EZNEWSplitter.prototype, {
        defineInstance: function () {
            var b = {
                ...
                panel2: null,
                _eventsMap: {
                    mousedown: a.EZNEW.mobile.getTouchEventName("touchstart"),
                    mouseup: a.EZNEW.mobile.getTouchEventName("touchend"),
                    mousemove: a.EZNEW.mobile.getTouchEventName("touchmove"),
            ...
            if (this === a.EZNEW._EZNEWSplitter.prototype) {
                return b
            }
        ...
        _initOverlay: function (b) {
            if (this.overlay || b == "undefined") {
                ...
                if (b == true) {
                    ...
                    this.overlay.addClass("EZNEW-disableselect");
        ...
        _startDrag: function (b) {
            ...
            if (this.overlay == null) {
                ...
                this._dragStart = a.EZNEW.position(b);
                return false
            }
            return true
        },
        _drag: function (b) {
            ...
            this._position = a.EZNEW.position(b);
            ...
            if (this._splitBarClone) {
                ...
                this._splitBarClone.removeClass(this.toThemeProperty("EZNEW-splitter-splitbar-invalid"));
                if (e < j) {
                    this._splitBarClone.addClass(this.toThemeProperty("EZNEW-splitter-splitbar-invalid"));
                    e = j
                }
                if (e > n + h - l - c) {
                    this._splitBarClone.addClass(this.toThemeProperty("EZNEW-splitter-splitbar-invalid"));
        ...
        _addHandlers: function () {
            var c = this;
            a.EZNEW.utilities.resize(this.host,
                function () {
                    c._layoutPanels()
                });
            this.addHandler(this.splitBar, "dragstart." + this.element.id,
                function (e) {
                    return false
                });
            if (this.splitBarButton) {
                this.addHandler(this.splitBarButton, "click." + this.element.id,
                    function () {
                        var e = function (f) {
                            if (!f.collapsed) {
                                c.collapse()
                ...
                this.addHandler(this.splitBarButton, this._eventName("mouseenter"),
                    function () {
                        c.splitBarButton.addClass(c.toThemeProperty("EZNEW-splitter-collapse-button-hover"));
                        c.splitBarButton.addClass(c.toThemeProperty("EZNEW-fill-state-hover"))
                    });
                this.addHandler(this.splitBarButton, this._eventName("mouseleave"),
                    function () {
                        c.splitBarButton.removeClass(c.toThemeProperty("EZNEW-splitter-collapse-button-hover"));
                        c.splitBarButton.removeClass(c.toThemeProperty("EZNEW-fill-state-hover"))
                    })
            }
            this.addHandler(a(document), this._eventName("mousemove") + "." + this.element.id,
                function (e) {
                    return c._drag(e)
                });
            this.addHandler(a(document), this._eventName("mouseup") + "." + this.element.id,
                function () {
                    return c._stopDrag()
                });
            this.addHandler(this.splitBar, this._eventName("mousedown"),
                function (e) {
                    return c._startDrag(e)
                });
            this.addHandler(this.splitBar, this._eventName("mouseenter"),
                function () {
                    if (c.resizable && !c.disabled) {
                        c.splitBar.addClass(c.toThemeProperty("EZNEW-splitter-splitbar-hover"));
                        c.splitBar.addClass(c.toThemeProperty("EZNEW-fill-state-hover"))
                    }
                });
            this.addHandler(this.splitBar, this._eventName("mouseleave"),
                function () {
                    if (c.resizable && !c.disabled) {
                        c.splitBar.removeClass(c.toThemeProperty("EZNEW-splitter-splitbar-hover"));
                        c.splitBar.removeClass(c.toThemeProperty("EZNEW-fill-state-hover"))
                    }
                });
        ...
        render: function () {
            ...
            if (c.length != 2) {
                throw "Invalid HTML Structure! EZNEWSplitter requires 1 container DIV tag and 2 nested DIV tags."
            }
            if (c.length == 2) {
                var e = c[0].className.split(" ");
                var b = c[1].className.split(" ");
                if (e.indexOf("EZNEW-reset") != -1 && e.indexOf("EZNEW-splitter") != -1 && e.indexOf("EZNEW-UI") != -1) {
                    throw "Invalid HTML Structure! Nested EZNEWSplitter cannot be initialized from a Splitter Panel. You need to add a new DIV tag inside the Splitter Panel and initialize the nested EZNEWSplitter from it!"
                }
                if (b.indexOf("EZNEW-reset") != -1 && b.indexOf("EZNEW-splitter") != -1 && b.indexOf("EZNEW-UI") != -1) {
                    throw "Invalid HTML Structure! Nested EZNEWSplitter cannot be initialized from a Splitter Panel. You need to add a new DIV tag inside the Splitter Panel and initialize the nested EZNEWSplitter from it!"
                }
            }
            if (this.host.parent().length > 0 && this.host.parent()[0].className.indexOf("EZNEW-splitter") != -1) {
                if (this.element.className.indexOf("EZNEW-splitter-panel") != -1) {
                    throw "Invalid HTML Structure! Nested EZNEWSplitter cannot be initialized from a Splitter Panel. You need to add a new DIV tag inside the Splitter Panel and initialize the nested EZNEWSplitter from it!"
                }
                this._isNested = true;
                if (this.width == 300) {
                ...
                if (this.width == "100%" && this.height == "100%") {
                    this.host.addClass("EZNEW-splitter-nested");
                    if (this.host.parent()[0].className.indexOf("EZNEW-splitter-panel") != -1) {
                        this.host.parent().addClass("EZNEW-splitter-panel-nested")
                    }
                }
            }
            this._hasBorder = (this.host.hasClass("EZNEW-hideborder") == false) || this.element.style.borderTopWidth != "";
            this._removeHandlers();
            this._isTouchDevice = a.EZNEW.mobile.isTouchDevice();
            this._validate();
        ...
        _hiddenParent: function () {
            return a.EZNEW.isHidden(this.host)
        },
        _setTheme: function () {
            this.panel1.addClass(this.toThemeProperty("EZNEW-UI-content"));
            this.panel2.addClass(this.toThemeProperty("EZNEW-UI-content"));
            this.panel1.addClass(this.toThemeProperty("EZNEW-splitter-panel"));
            this.panel2.addClass(this.toThemeProperty("EZNEW-splitter-panel"));
            this.panel1.addClass(this.toThemeProperty("EZNEW-reset"));
            this.panel2.addClass(this.toThemeProperty("EZNEW-reset"));
            this.host.addClass(this.toThemeProperty("EZNEW-reset"));
            this.host.addClass(this.toThemeProperty("EZNEW-splitter"));
            this.host.addClass(this.toThemeProperty("EZNEW-UI"));
            this.host.addClass(this.toThemeProperty("EZNEW-UI-content"));
            this.splitBar.addClass(this.toThemeProperty("EZNEW-splitter-splitbar-" + this.orientation));
            this.splitBar.addClass(this.toThemeProperty("EZNEW-fill-state-normal"));
            this.splitBarButton.addClass(this.toThemeProperty("EZNEW-splitter-collapse-button-" + this.orientation));
            this.splitBarButton.addClass(this.toThemeProperty("EZNEW-fill-state-pressed"))
        },
        _validate: function () {
            var b = this.host.children();
            if (b.length != 2) {
                throw "Invalid HTML Structure! EZNEWSplitter requires two nested DIV tags!"
            }
        ...
        collapse: function () {
            ...
            if (b != -1) {
                ...
                this.splitBar.addClass(this.toThemeProperty("EZNEW-splitter-splitbar-collapsed"));
                this._layoutPanels();
                this._raiseEvent(2, {
                    index: b,
                    panels: this.panels
        ...
        expand: function () {
            ...
            if (b != -1) {
                ...
                this.splitBar.removeClass(this.toThemeProperty("EZNEW-splitter-splitbar-collapsed"));
                this._layoutPanels();
                this._raiseEvent(1, {
                    index: b,
                    panels: this.panels
        ...
        disable: function () {
            this.disabled = true;
            this.host.addClass(this.toThemeProperty("EZNEW-fill-state-disabled"));
            this.splitBar.addClass(this.toThemeProperty("EZNEW-splitter-splitbar-collapsed"));
            this.splitBarButton.addClass(this.toThemeProperty("EZNEW-splitter-splitbar-collapsed"))
        },
        enable: function () {
            this.disabled = false;
            this.host.removeClass(this.toThemeProperty("EZNEW-fill-state-disabled"));
            this.splitBar.removeClass(this.toThemeProperty("EZNEW-splitter-splitbar-collapsed"));
            this.splitBarButton.removeClass(this.toThemeProperty("EZNEW-splitter-splitbar-collapsed"))
        },
        refresh: function (b) {
            if (b != true) {
                this._arrange()
        ...
        propertyChangedHandler: function (b, c, e, d) {
            ...
            if (c === "disabled") {
                ...
                if (c === "theme") {
                    a.EZNEW.utilities.setTheme(e, d, b.host)
                } else {
                    b.refresh()
                }
            }
        ...
        destroy: function () {
            this._removeHandlers();
            a.EZNEW.utilities.resize(this.host, null, true);
            this.host.remove()
        },
