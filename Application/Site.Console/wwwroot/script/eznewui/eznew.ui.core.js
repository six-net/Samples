...
if (!oldBrowser) { (function(bd, G) {
        ...
        C.extend({
            ...
            globalEval: function(bu) {
                if (bu && at.test(bu)) { (bd.execScript ||
                    function(bv) {
                        bd["eval"].call(bd, bv)
                    })(bu)
                }
        ...
        C.Callbacks = function(bE) {
            bE = typeof bE === "string" ? (aX[bE] || B(bE)) : C.extend({},
            bE);
            ...
            bD = {
                add: function() {
                    if (bB) {
                        var bG = bB.length; (function bF(bH) {
                            C.each(bH,
                            function(bJ, bI) {
                                var bK = C.type(bI);
                                if (bK === "function") {
        ...
        C.extend({
            ...
            deletedIds: [],
            uuid: 0,
            expando: "EZNEWLite" + (C.fn.EZNEW + Math.random()).replace(/\D/g, ""),
            noData: {
                embed: true,
         ...
         * Copyright 2012 EZNEWLite Foundation and other contributors
        ...
        (function(cn, bM) {
            ...
            cg = cl.selectors = {
                ...
                filter: {
                    ...
                    CLASS: function(cC) {
                        var cD = cp[cu][cC + " "];
                        return cD || (cD = new RegExp("(^|" + b3 + ")" + cC + "(" + b3 + "|$)")) && cp(cC,
                        function(cE) {
            ...
            if (bD.querySelectorAll) { (function() {
                    var cH, cI = ct,
                    cG = /'|\\/g,
                    cE = /\=[\x20\t\r\n\f]*([^'"\]]*)[\x20\t\r\n\f]*\]/g,
                    cD = [":focus"],
        ...
        C.fn.extend({
            ...
            index: function(bu) {
                ...
                return C.inArray(bu.EZNEW ? bu[0] : bu, this)
            },
            add: function(bu, bv) {
        ...
        C.fn.extend({
            ...
            serializeArray: function() {
                return this.map(function() {
                    ...
                    var bw = C(this).val();
                    return bw == null ? null: C.isArray(bw) ? C.map(bw,
                    function(by, bx) {
                        return {
                            name: bv.name,
                            value: by.replace(br, "\r\n")
        ...
        C.param = function(bu, bw) {
            ...
            if (C.isArray(bu) || (bu.EZNEW && !C.isPlainObject(bu))) {
                C.each(bu,
                function() {
        ...
        C.speed = function(bw, bx, bv) {
            var bu = bw && typeof bw === "object" ? C.extend({},
            bw) : {
        ...
        bd.EZNEWLite = bd.EZNEWHelper = C;
        if (typeof define === "function" && define.amd && define.amd.EZNEWLite) {
            define("EZNEW", [],
            function() {
                return C
            })
    ...
    if (a.jQuery) {
        a.minQuery = a.EZNEWLite = a.jQuery;
        return
    }
    if (!a.$) {
        a.$ = a.minQuery = a.EZNEWLite
    } else {
        a.minQuery = a.EZNEWLite = a.$
    }
})(window);
EZNEWLite.generateID = function() {
    var a = function() {
...
var EZNEWBaseFramework = window.EZNEWBaseFramework = window.minQuery || window.jQuery; (function(b) {
    b.EZNEW = b.EZNEW || {};
    window.EZNEW = b.EZNEW;
    var a = {
        createInstance: function(c, e, g) {
            if (e == "EZNEWDataAdapter") {
                var f = g[0];
                var d = g[1] || {};
                return new b.EZNEW.dataAdapter(f, d)
            }
            b(c)[e](g || {});
    ...
    b.EZNEW.getByPriority = function(c) {
        var e = undefined;
    ...
    b.EZNEW.hasProperty = function(d, c) {
        if (typeof(c) == "object") {
            for (var f in c) {
                var e = d;
                while (e) {
    ...
    b.EZNEW.hasFunction = function(f, e) {
        if (e.length == 0) {
            return false
        }
        if (f == undefined) {
    ...
    b.EZNEW.isPropertySetter = function(d, c) {
        if (c.length == 1 && typeof(c[0]) == "object") {
            return true
        }
        if (c.length == 2 && typeof(c[0]) == "string" && !b.EZNEW.hasFunction(d, c)) {
            return true
        }
        return false
    };
    b.EZNEW.validatePropertySetter = function(g, e, c) {
        if (!b.EZNEW.propertySetterValidation) {
            return true
        }
    ...
    b.EZNEW.set = function(f, i) {
        ...
        if (i.length == 1 && typeof(i[0]) == "object") {
            ...
            function(l, m) {
                ...
                if (n.hasOwnProperty(l)) {
                    b.EZNEW.setvalueraiseevent(n, l, m)
                } else {
                    if (n.hasOwnProperty(l.toLowerCase())) {
                        b.EZNEW.setvalueraiseevent(n, l.toLowerCase(), m)
                    } else {
                        if (b.EZNEW.propertySetterValidation) {
                            throw "EZNEWCore: invalid property '" + l + "'"
                        }
                    }
                }
            });
            ...
            if (i.length == 2) {
                ...
                if (f.hasOwnProperty(i[0])) {
                    b.EZNEW.setvalueraiseevent(f, i[0], i[1])
                } else {
                    if (f.hasOwnProperty(i[0].toLowerCase())) {
                        b.EZNEW.setvalueraiseevent(f, i[0].toLowerCase(), i[1])
                    } else {
                        if (b.EZNEW.propertySetterValidation) {
                            throw "EZNEWCore: invalid property '" + i[0] + "'"
                        }
                    }
                }
            }
    ...
    b.EZNEW.setvalueraiseevent = function(d, e, f) {
        var c = d[e];
        d[e] = f;
        if (!d.isInitialized) {
            return
    ...
    b.EZNEW.propertySetterValidation = true;
    b.EZNEW.EZNEWUIProxy = function(h, d, c) {
        var e = b(d);
        var g = b.data(d, h);
        if (g == undefined) {
            return undefined
        ...
        var f = g.instance;
        if (b.EZNEW.hasFunction(f, c)) {
            return b.EZNEW.invoke(f, c)
        }
        if (b.EZNEW.isPropertySetter(f, c)) {
            if (b.EZNEW.validatePropertySetter(f, c)) {
                b.EZNEW.set(f, c);
                return undefined
            }
        } else {
            if (typeof(c) == "object" && c.length == 0) {
                ...
                if (typeof(c) == "object" && c.length == 1 && b.EZNEW.hasProperty(f, c[0])) {
                    return b.EZNEW.get(f, c[0])
                } else {
                    if (typeof(c) == "string" && b.EZNEW.hasProperty(f, c[0])) {
                        return b.EZNEW.get(f, c)
                    }
                }
            }
        }
        throw "EZNEWCore: Invalid parameter '" + b.EZNEW.serialize(c) + "' does not exist."
    };
    b.EZNEW.applyUI = function(d, f, l, m) {
        var h = false;
        try {
        ...
        if (d.id == "") {
            d.id = b.EZNEW.utilities.createId()
        }
        var k = {
            host: n,
            element: d,
        ...
        j.reverse();
        j[0].theme = b.EZNEW.theme || "";
        b.EZNEW.EZNEWUIProxy(f, d, l);
        for (var c in j) {
            m = j[c];
            if (c == 0) {
                m.host = n;
    ...
    b.EZNEW.EZNEWUI = function(c, d, g) {
        var j = false;
        try {
        ...
        if (!window[h]) {
            ...
            a[h] = window[h] = function(e, s) {
                ...
                if (b.type(o) === "object" && e[0]) {
                    o = e[0].id;
                    if (o === "") {
                        o = e[0].id = b.EZNEW.utilities.createId()
                    }
                } else {
                    if (b.type(e) === "object" && e && e.nodeName) {
                        o = e.id;
                        if (o === "") {
                            o = e.id = b.EZNEW.utilities.createId()
                        }
                    }
                }
                if (window.EZNEWUIs && window.EZNEWUIs[o]) {
                    if (s) {
                        b.each(window.EZNEWUIs[o],
                        function(t) {
                    ...
                    if (window.EZNEWUIs[o].length == 1) {
                        var q = b(window.EZNEWUIs[o][0].UIInstance.element).data();
                        if (q && q.EZNEWUI) {
                            return window.EZNEWUIs[o][0]
                        }
                    }
                    var q = b(window.EZNEWUIs[o][0].UIInstance.element).data();
                    if (q && q.EZNEWUI) {
                        return window.EZNEWUIs[o]
                    }
                }
                var p = b(e);
                if (p.length === 0) {
                    p = b("<div></div>");
                    if (h === "EZNEWInput" || h === "EZNEWPasswordInput" || h === "EZNEWMaskedInput") {
                        p = b("<input/>")
                    }
                    if (h === "EZNEWTextArea") {
                        p = b("<textarea></textarea>")
                    }
                    if (h === "EZNEWButton" || h === "EZNEWRepeatButton" || h === "EZNEWToggleButton") {
                        p = b("<button/>")
                    }
                    if (h === "EZNEWSplitter") {
                ...
                function(w) {
                    var y = p[w];
                    b.EZNEW.applyUI(y, h, n, undefined);
                    if (!k[h]) {
                        var u = b.data(y, "EZNEWUI");
                        var x = b.EZNEW["_" + h].prototype.defineInstance();
                        var v = {};
                        if (b.EZNEW["_" + h].prototype.metaInfo) {
                            v = b.EZNEW["_" + h].prototype.metaInfo()
                        }
                        if (h == "EZNEWDockingLayout") {
                            x = b.extend(x, b.EZNEW._EZNEWLayout.prototype.defineInstance())
                        }
                        if (h == "EZNEWToggleButton" || h == "EZNEWRepeatButton") {
                            x = b.extend(x, b.EZNEW._EZNEWButton.prototype.defineInstance())
                        }
                        if (h == "EZNEWTreeGrid") {
                            x = b.extend(x, b.EZNEW._EZNEWDataTable.prototype.defineInstance())
                        }
                        var t = function(A) {
                            var z = b.data(A, "EZNEWUI");
                            this.UIInstance = z;
                        ...
                        function(A, z) {
                            Object.defineProperty(t.prototype, A, {
                                get: function() {
                                    if (this.UIInstance) {
                                        return this.UIInstance[A]
                                    }
                                    return z
                                },
                                set: function(H) {
                                    if (this.UIInstance && (this.UIInstance[A] != H || A === "width" || A === "height")) {
                                        var F = this.UIInstance[A];
                                        var E = H;
                                        var D = b.type(F);
                                        var B = b.type(E);
                                        var G = false;
                                        ...
                                        if (G || (f(F) != f(E))) {
                                            var C = {};
                                            C[A] = H;
                                            if (this.UIInstance.host) {
                                                this.UIInstance.host[h](C)
                                            } else {
                                                this.UIInstance.base.host[h](C)
                                            }
                                            this.UIInstance[A] = H;
                                            if (this.UIInstance.propertyUpdated) {
                                                this.UIInstance.propertyUpdated(A, F, H)
                                            }
                                        }
                                    }
                                }
                    ...
                    r.push(u);
                    if (!window.EZNEWUIs) {
                        window.EZNEWUIs = new Array()
                    }
                    if (!window.EZNEWUIs[o]) {
                        window.EZNEWUIs[o] = new Array()
                    }
                    window.EZNEWUIs[o].push(u)
                });
                if (r.length === 1) {
                    return r[0]
                }
        ...
        b.fn[h] = function() {
            ...
            if (e.length == 0 || (e.length == 1 && typeof(e[0]) == "object")) {
                ...
                return this.each(function() {
                    ...
                    var r = b.data(p, h);
                    if (r == null) {
                        b.EZNEW.applyUI(p, h, e, undefined)
                    } else {
                        b.EZNEW.EZNEWUIProxy(h, this, e)
                    }
                })
            } else {
                if (this.length == 0) {
                ...
                var n = 0;
                this.each(function() {
                    var p = b.EZNEW.EZNEWUIProxy(h, this, e);
                    if (n == 0) {
                        o = p;
                        n++
                    } else {
        ...
        try {
            b.extend(b.EZNEW["_" + h].prototype, Array.prototype.slice.call(g, 0)[0])
        } catch(i) {}
        b.extend(b.EZNEW["_" + h].prototype, {
            toThemeProperty: function(e, n) {
                return b.EZNEW.toThemeProperty(this, e, n)
            },
            ...
            _addBarAndLabel: function(p) {
                ...
                e.addClass(o.toThemeProperty("EZNEW-input-label"));
                p.after(e);
                o.label = e;
                var n = b("<span></span>");
                p.after(n);
                n.addClass(o.toThemeProperty("EZNEW-input-bar"));
                o.bar = n;
                o.bar.css("top", this.host.height())
            }
        });
        b.EZNEW["_" + h].prototype.refresh = function() {
            if (this.base) {
                this.base.refresh(true)
            }
        };
        b.EZNEW["_" + h].prototype.createInstance = function() {};
        b.EZNEW["_" + h].prototype.addEventHandler = function(n, e) {
            if (this.base) {
        ...
        b.EZNEW["_" + h].prototype.removeEventHandler = function(n, e) {
            if (this.base) {
        ...
        b.EZNEW["_" + h].prototype.applyTo = function(o, n) {
            if (! (n instanceof Array)) {
                var e = [];
                e.push(n);
                n = e
            }
            b.EZNEW.applyUI(o, h, n, this)
        };
        b.EZNEW["_" + h].prototype.getInstance = function() {
            return this
        };
        b.EZNEW["_" + h].prototype.propertyChangeMap = {};
        b.EZNEW["_" + h].prototype.addHandler = function(p, e, n, o) {
            b.EZNEW.addHandler(b(p), e, n, o)
        };
        b.EZNEW["_" + h].prototype.removeHandler = function(o, e, n) {
            b.EZNEW.removeHandler(b(o), e, n)
        };
        b.EZNEW["_" + h].prototype.setOptions = function() {
            if (!this.host || !this.host.length || this.host.length != 1) {
                return
            }
            return b.EZNEW.EZNEWUIProxy(h, this.host[0], arguments)
        }
    };
    b.EZNEW.toThemeProperty = function(d, e, j) {
        if (d.theme == "") {
            return e
        }
        var h = e.split(" ");
    ...
    b.EZNEW.addHandler = function(h, j, f, g) {
        var d = j.split(" ");
    ...
    b.EZNEW.removeHandler = function(g, h, f) {
        if (!h) {
            if (g.off) {
                g.off()
            } else {
    ...
    b.EZNEW.credits = b.EZNEW.credits || "";
    b.EZNEW.theme = b.EZNEW.theme || "";
    b.EZNEW.scrollAnimation = b.EZNEW.scrollAnimation || false;
    b.EZNEW.resizeDelay = b.EZNEW.resizeDelay || 10;
    b.EZNEW.ready = function() {
        b(window).trigger("EZNEWReady")
    };
    b.EZNEW.init = function() {
        b.each(arguments[0],
        function(c, d) {
            if (c == "theme") {
                b.EZNEW.theme = d
            ...
            if (c == "scrollBarSize") {
                b.EZNEW.utilities.scrollBarSize = d
            }
            if (c == "touchScrollBarSize") {
                b.EZNEW.utilities.touchScrollBarSize = d
            }
            if (c == "scrollBarButtonsVisibility") {
                b.EZNEW.utilities.scrollBarButtonsVisibility = d
            }
        })
    };
    b.EZNEW.utilities = b.EZNEW.utilities || {};
    b.extend(b.EZNEW.utilities, {
        scrollBarSize: 13,
        ...
        getOffset: function(c) {
            var e = b.EZNEW.mobile.getLeftPos(c[0]);
            var d = b.EZNEW.mobile.getTopPos(c[0]);
            return {
                top: d,
                left: e
            }
        ...
        resize: function(h, t, q, p) {
            ...
            var e = function(v) {
                ...
                var w = -1;
                for (var u = 0; u < l.hiddenUIs.length; u++) {
                    if (v.id) {
                        if (l.hiddenUIs[u].id == v.id) {
                            w = u;
                            break
                        }
                    } else {
                        if (l.hiddenUIs[u].id == v[0].id) {
                            w = u;
                            break
                        }
                    }
            ...
            if (this.resizeHandlers) {
                ...
                if (q === true) {
                    ...
                    if (this.resizeHandlers.length == 0) {
                        ...
                        if (o.off) {
                            o.off("resize.EZNEW");
                            o.off("orientationchange.EZNEW");
                            o.off("orientationchanged.EZNEW")
                        } else {
                            o.unbind("resize.EZNEW");
                            o.unbind("orientationchange.EZNEW");
                            o.unbind("orientationchanged.EZNEW")
                        }
                        this.resizeHandlers = null
                    }
                    var c = e(h);
                    if (c != -1 && this.hiddenUIs) {
                        this.hiddenUIs.splice(c, 1)
                    }
                    return
                }
            } else {
            ...
            var n = function(w, F) {
                ...
                var x = function(J) {
                    if (l.hiddenUIs.length > 0) {
                        l.hiddenUIs.sort(v);
                        var i = function() {
                            var L = false;
                            var N = new Array();
                            for (var M = 0; M < l.hiddenUIs.length; M++) {
                                var K = l.hiddenUIs[M];
                                if (b.EZNEW.isHidden(K.UI)) {
                                    L = true;
                                    N.push(K)
                                } else {
                                    if (K.callback) {
                ...
                if (l.hiddenUIs && l.hiddenUIs.length > 0) {
                    x(false)
                }
                l.hiddenUIs = new Array();
                ...
                for (var C = 0; C < l.resizeHandlers.length; C++) {
                    ...
                    var u = B.EZNEWUI.width;
                    var H = B.EZNEWUI.height;
                    if (B.EZNEWUI.base) {
                        if (u == undefined) {
                            u = B.EZNEWUI.base.width
                        }
                        if (H == undefined) {
                            H = B.EZNEWUI.base.height
                        }
                    }
                    if (u === undefined && H === undefined) {
                        u = B.EZNEWUI.element.style.width;
                        H = B.EZNEWUI.element.style.height
                    }
                    var D = false;
                    ...
                    if (b.EZNEW.isHidden(E)) {
                        if (e(E) === -1) {
                            if (D || w === true) {
                                if (I.data.nestedUI !== true) {
                                    l.hiddenUIs.push(I)
                                }
                            }
                        }
                            ...
                            if (D) {
                                ...
                                if (l.watchedElementData) {
                                    for (var z = 0; z < l.watchedElementData.length; z++) {
                                        if (l.watchedElementData[z].element == B.EZNEWUI.element) {
                                            l.watchedElementData[z].offsetWidth = B.EZNEWUI.element.offsetWidth;
                                            l.watchedElementData[z].offsetHeight = B.EZNEWUI.element.offsetHeight;
                                            break
                                        }
                                    }
                                }
                                if (l.hiddenUIs.indexOf(I) >= 0) {
                                    l.hiddenUIs.splice(l.hiddenUIs.indexOf(I), 1)
                                }
                            }
                            if (B.EZNEWUI.element) {
                                var y = B.EZNEWUI.element.className;
                                if (y.indexOf("dropdownlist") >= 0 || y.indexOf("datetimeinput") >= 0 || y.indexOf("combobox") >= 0 || y.indexOf("menu") >= 0) {
                                    if (B.EZNEWUI.isOpened) {
                                        var A = B.EZNEWUI.isOpened();
                                        if (A) {
                                            if (F && F == "resize" && b.EZNEW.mobile.isTouchDevice()) {
                                                continue
                                            }
                                            B.EZNEWUI.close()
                                        }
            ...
            if (!this.resizeHandlers) {
                ...
                if (o.on) {
                    ...
                    o.on("orientationchange.EZNEW",
                    function(i) {
                        n(null, "orientationchange")
                    });
                    o.on("orientationchanged.EZNEW",
                    function(i) {
                        n(null, "orientationchange")
                    })
                } else {
                    ...
                    o.bind("orientationchange.EZNEW",
                    function(i) {
                        n(null, "orientationchange")
                    });
                    o.bind("orientationchanged.EZNEW",
                    function(i) {
                        n(null, "orientationchange")
                    })
                }
            ...
            try {
                var d = f.EZNEWUI.width;
                var s = f.EZNEWUI.height;
                if (f.EZNEWUI.base) {
                    if (d == undefined) {
                        d = f.EZNEWUI.base.width
                    }
                    if (s == undefined) {
                        s = f.EZNEWUI.base.height
                    }
                }
                if (d === undefined && s === undefined) {
                    d = f.EZNEWUI.element.style.width;
                    s = f.EZNEWUI.element.style.height
                }
                var k = false;
                            ...
                            l.watchedElementData.forEach(function(u) {
                                if (u.element.offsetWidth !== u.offsetWidth || u.element.offsetHeight !== u.offsetHeight) {
                                    ...
                                    u.timer = setTimeout(function() {
                                        if (!b.EZNEW.isHidden(b(u.element))) {
                                            u.callback()
                                        } else {
            ...
            if (b.EZNEW.isHidden(h) && p === true) {
                n(true)
            }
            b.EZNEW.resize = function() {
                n(null, "resize")
            }
        },
        ...
        hasTransform: function(e) {
            ...
            if (d == "" || d == "none") {
                ...
                if (d == "" || d == "none") {
                    var c = b.EZNEW.utilities.getBrowser();
                    if (c.browser == "msie") {
    ...
    b.EZNEW.browser = b.EZNEW.utilities.getBrowser();
    b.EZNEW.isHidden = function(d) {
        if (!d || !d[0]) {
            return false
        }
    ...
    b.EZNEW.ariaEnabled = true;
    b.EZNEW.aria = function(d, f, e) {
        if (!b.EZNEW.ariaEnabled) {
            return
        }
        if (f == undefined) {
            b.each(d.aria,
            function(h, i) {
                ...
                if (k != undefined && !b.isFunction(k)) {
                    ...
                    try { ! d.base ? d.host.attr(h, k.toString()) : d.base.host.attr(h, k.toString())
                    } catch(g) {}
                }
            })
        } else {
    ...
    b.EZNEW.mobile = b.EZNEW.mobile || {};
    b.EZNEW.position = function(c) {
        var f = parseInt(c.pageX);
        var e = parseInt(c.pageY);
        if (b.EZNEW.mobile.isTouchDevice()) {
            var d = b.EZNEW.mobile.getTouches(c);
            var g = d[0];
            f = parseInt(g.pageX);
            e = parseInt(g.pageY)
        }
    ...
    b.extend(b.EZNEW.mobile, {
        ...
        touchScroll: function(B, M, Z, H, x, n) {
            ...
            var X = function(am) {
                ...
                aa = n.EZNEWScrollBar("value");
                h = x.EZNEWScrollBar("value");
                var an = G.getTouches(am);
                var ao = an[0];
                if (an.length == 1) {
                    G.dispatchMouseEvent("mousedown", ao, G.getRootNode(ao.target))
                }
                Y = x.EZNEWScrollBar("max");
                Q = n.EZNEWScrollBar("max");
                function al(ap) {
                    C = false;
                    F = true;
                    d = A(ap);
    ...
    b.EZNEW.cookie = b.EZNEW.cookie || {};
    b.extend(b.EZNEW.cookie, {
    ...
    b.EZNEW.string = b.EZNEW.string || {};
    b.extend(b.EZNEW.string, {
    ...
    b.fn.EZNEWProxy = function() {
        var e = b(this).data().EZNEWUI;
        var c = Array.prototype.slice.call(arguments, 0);
        var d = e.element;
        if (!d) {
            d = e.base.element
        }
        return b.EZNEW.EZNEWUIProxy(e.UIName, d, c)
    };
    var a = b.originalVal = b.fn.val;
    b.fn.val = function(d) {
        if (typeof d == "undefined") {
            if (b(this).hasClass("EZNEW-UI")) {
                var c = b(this).data().EZNEWUI;
                if (c && c.val) {
                    return c.val()
                }
            }
            if (this[0] && this[0].tagName.toLowerCase().indexOf("angular") >= 0) {
                var c = b(this).find(".EZNEW-UI").data().EZNEWUI;
                if (c && c.val) {
                    return c.val()
                }
            }
        ...
        b.fn.modal.Constructor.prototype.enforceFocus = function() {
            b(document).off("focusin.bs.modal").on("focusin.bs.modal", b.proxy(function(c) {
                if (this.$element[0] !== c.target && !this.$element.has(c.target).length) {
                    if (b(c.target).parents().hasClass("EZNEW-popup")) {
                        return true
                    }
    ...
    b.EZNEW.ripple = function(f, e, o) {
        ...
        var p = h.find(".ink");
        var c = false;
        for (var g = 0; g < b.EZNEW.ripplers.length; g++) {
            var k = b.EZNEW.ripplers[g];
            if (k.element[0] === f[0]) {
                c = true;
                break
            }
        ...
        if (b.EZNEW.ripplers.length === 1) {
            b(document).on("mouseup",
            function(r) {
                b.EZNEW.ripple.mouseCaptured = false;
                for (var q = 0; q < b.EZNEW.ripplers.length; q++) {
                    var d = b.EZNEW.ripplers[q];
        ...
        e.on("mousedown.ripple",
        function(i) {
            var d = b(f);
            b.EZNEW.ripple.mouseCaptured = true;
            setTimeout(function() {
                ...
                if (o === "checkbox" || o === "radiobutton") {
                    if (o === "checkbox") {
                        if (e.EZNEWCheckBox("disabled")) {
                            return
                        }
                    }
                    if (o === "radiobutton") {
                        if (e.EZNEWRadioButton("disabled")) {
                            return
                        }
                    }
                    ...
                    r.on("animationend",
                    function() {
                        if (b.EZNEW.ripple.mouseCaptured) {
                            r.removeClass("animate");
                            r.addClass("active");
                            f.addClass("active")
                        }
