...
import { getPaginationInfo, getLwtPaginationInfo } from '@/utils/paginationInfo'

const accessToken = store.getters['sys/user/accessToken']
...
const install = (Vue, opts = {}) => {
  ...
  /*全局页面状态*/
  Vue.prototype.$getPageStatus = getPageStatus
  /*全局获取分页信息*/
  Vue.prototype.$getPaginationInfo = getPaginationInfo
  Vue.prototype.$getLwtPaginationInfo = getLwtPaginationInfo
}
