...
<script>
  ...
  export default {
    ...
    created() {
      ...
      const theme = localStorage.getItem('eznew-net-theme')
      if (null !== theme) {
    ...
    methods: {
      ...
      handleSetTheme() {
        ...
        document.getElementsByTagName(
          'body'
        )[0].className = `eznew-net-theme-${name}`
      ...
      handleSetDfaultTheme() {
        ...
        document
          ...
          .classList.remove(`eznew-net-theme-${name}`)
        localStorage.removeItem('eznew-net-theme')
